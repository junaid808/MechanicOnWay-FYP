...
public class MechanicMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(MechanicMapsActivity.this);


        SettingsDriverButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MechanicMapsActivity.this, SettingActivity.class);
    ...
    private void getAssignedCustomersRequest() {
        AssignedCustomerRef = FirebaseDatabase.getInstance().getReference().child("Users")
                .child("Mechanics").child(driverID) .child("CustomerRideID");
    ...
    {
        Intent startPageIntent = new Intent(MechanicMapsActivity.this, MechanicLogIn.class);
