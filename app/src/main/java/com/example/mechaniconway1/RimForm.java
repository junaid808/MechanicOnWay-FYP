...
public class RimForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rim_form);
        ...
        CustomerName = findViewById(R.id.nameRimsForm);
        CustomerAddress = findViewById(R.id.addressRimsForm);
        CustomerEmail = findViewById(R.id.emailRimsForm);
        CustomerContact = findViewById(R.id.contactRimsForm);
        CustomerService = findViewById(R.id.rimSpinner);
        BookingDate = findViewById(R.id.set_dateRimsForm);
        BookingTime = findViewById(R.id.set_timeRimsForm);


        date = (Button) findViewById(R.id.selectdateRimsForm);
        time = (Button) findViewById(R.id.selecttimeRimsForm);
        set_date = (TextView) findViewById(R.id.set_dateRimsForm);
        set_time = (TextView) findViewById(R.id.set_timeRimsForm);
        Spinner dropdown = findViewById(R.id.rimSpinner);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case Date_id:
                ...
                return new DatePickerDialog(RimForm.this, date_listener, year,
                        month, day);
            case Time_id:

                // Open the timepicker dialog
                return new TimePickerDialog(RimForm.this, time_listener, hour,
                        minute, false);
