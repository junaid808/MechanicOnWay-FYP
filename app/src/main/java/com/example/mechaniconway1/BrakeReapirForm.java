...
public class BrakeReapirForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brake_repair_form);

        mAuth = FirebaseAuth.getInstance();
        currentUser = mAuth.getCurrentUser();
        CustomerDatabaseRef = FirebaseDatabase.getInstance().getReference().child("CustomerBookings");

        CustomerName = findViewById(R.id.nameBreakRepairForm);
        CustomerAddress = findViewById(R.id.addressBreakRepairForm);
        CustomerEmail = findViewById(R.id.emailBreakRepairForm);
        CustomerContact = findViewById(R.id.contactBreakRepairForm);
        CustomerService = findViewById(R.id.BreakRepairFormSpinner);
        BookingDate = findViewById(R.id.set_dateBreakRepairForm);
        BookingTime = findViewById(R.id.set_timeBreakRepairForm);

        date = (Button) findViewById(R.id.selectdateBreakRepairForm);
        time = (Button) findViewById(R.id.selecttimeBreakRepairForm);
        set_date = (TextView) findViewById(R.id.set_dateBreakRepairForm);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case Date_id:
                ...
                return new DatePickerDialog(BrakeReapirForm.this, date_listener, year,
                        month, day);
            case Time_id:

                // Open the timepicker dialog
                return new TimePickerDialog(BrakeReapirForm.this, time_listener, hour,
                        minute, false);
