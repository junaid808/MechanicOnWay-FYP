...
public class PetrolForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomerName = findViewById(R.id.namePetrolForm);
        CustomerAddress = findViewById(R.id.addressPetrolForm);
        CustomerEmail = findViewById(R.id.emailPetrolForm);
        CustomerContact = findViewById(R.id.contactPetrolForm);
        CustomerService = findViewById(R.id.petroliumSpinner);
        BookingDate = findViewById(R.id.set_datePetrolForm);
        BookingTime = findViewById(R.id.set_timePetrolForm);

        date = (Button) findViewById(R.id.selectdatePetrolForm);
        time = (Button) findViewById(R.id.selecttimePetrolForm);
        set_date = (TextView) findViewById(R.id.set_datePetrolForm);
        set_time = (TextView) findViewById(R.id.set_timePetrolForm);
        Spinner dropdown = findViewById(R.id.petroliumSpinner);
//create a list of items for the spinner.
        String[] items = new String[]{

                "1 Litre Petrol @ RS 120 ", "2 Litre Petrol @ RS 240", "3 Litre Petrol @ RS 360", "4 Litre Petrol @ RS 480", "5 Litre Petrol @ RS 600"/*,"6 Litre Petrol","7 Litre Petrol","8 Litre Petrol","9 Litre Petrol","10 Litre Petrol"*/
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case Date_id:
                ...
                return new DatePickerDialog(PetrolForm.this, date_listener, year,
                        month, day);
            case Time_id:

                // Open the timepicker dialog
                return new TimePickerDialog(PetrolForm.this, time_listener, hour,
                        minute, false);
