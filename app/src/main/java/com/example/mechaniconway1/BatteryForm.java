...
public class BatteryForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomerName = findViewById(R.id.nameBatteryForm);
        CustomerAddress = findViewById(R.id.addressBatteryForm);
        CustomerEmail = findViewById(R.id.emailBatteryForm);
        CustomerContact = findViewById(R.id.contactBatteryForm);
        CustomerService = findViewById(R.id.batterySpinner);
        BookingDate = findViewById(R.id.set_dateBatteryForm);
        BookingTime = findViewById(R.id.set_timeBatteryForm);

        date = (Button) findViewById(R.id.selectdateBatteryForm);
        time = (Button) findViewById(R.id.selecttimeBatteryForm);
