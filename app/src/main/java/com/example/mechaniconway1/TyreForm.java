...
public class TyreForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomerName = findViewById(R.id.nameTyreForm);
        CustomerAddress = findViewById(R.id.addressTyreForm);
        CustomerEmail = findViewById(R.id.emailTyreForm);
        CustomerContact = findViewById(R.id.contactTyreForm);
        CustomerService = findViewById(R.id.tyreSpinner);
        BookingDate = findViewById(R.id.set_dateTyreForm);
        BookingTime = findViewById(R.id.set_timeTyreForm);

        date = (Button) findViewById(R.id.selectdateTyreForm);
        time = (Button) findViewById(R.id.selecttimeTyreForm);
        set_date = (TextView) findViewById(R.id.set_dateTyreForm);
        set_time = (TextView) findViewById(R.id.set_timeTyreForm);
        Spinner dropdown = findViewById(R.id.tyreSpinner);
        //create a list of items for the spinner.
        String[] items = new String[]{"Tyre Puncture Services @ RS:250 "};
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case Date_id:
                ...
                return new DatePickerDialog(TyreForm.this, date_listener, year,
                        month, day);
            case Time_id:

                // Open the timepicker dialog
                return new TimePickerDialog(TyreForm.this, time_listener, hour,
                        minute, false);
