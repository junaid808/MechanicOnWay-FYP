...
public class SignUpMechanic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up_mechanic);
        ...
        SignInTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SignUpMechanic.this, MechanicLogIn.class);
        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password1).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Intent intent=new Intent(SignUpMechanic.this,MechanicMapsActivity.class);
                    startActivity(intent);
                    Toast.makeText(SignUpMechanic.this,"Successfully registered",Toast.LENGTH_LONG).show();
                    finish();
                }
                else{
                    Toast.makeText(SignUpMechanic.this,"Sign up fail!",Toast.LENGTH_LONG).show();
                }
